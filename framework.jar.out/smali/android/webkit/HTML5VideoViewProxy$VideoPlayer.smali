...
.method static synthetic access$500(Landroid/webkit/WebChromeClient;Landroid/webkit/HTML5VideoViewProxy;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 99
    invoke-static {p0, p1}, Landroid/webkit/HTML5VideoViewProxy$VideoPlayer;->showWaitingStateIfVideoViewPreparing(Landroid/webkit/WebChromeClient;Landroid/webkit/HTML5VideoViewProxy;)V
...
.method private static showWaitingStateIfVideoViewPreparing(Landroid/webkit/WebChromeClient;Landroid/webkit/HTML5VideoViewProxy;)V
    .locals 4
    .parameter "client"
    .parameter "proxy"
    ...
    invoke-virtual {v1}, Landroid/widget/VideoView;->isPreparing()Z
    ...
    sget-object v1, Landroid/webkit/HTML5VideoViewProxy$VideoPlayer;->mLayout:Landroid/widget/FrameLayout;
    ...
    sget-object v2, Landroid/webkit/HTML5VideoViewProxy$VideoPlayer;->mProgressView:Landroid/view/View;

    invoke-virtual {v1, v2}, Landroid/widget/FrameLayout;->removeView(Landroid/view/View;)V

    .line 224
    :cond_0
    invoke-virtual {p0}, Landroid/webkit/WebChromeClient;->getVideoLoadingProgressView()Landroid/view/View;

    move-result-object v1

    sput-object v1, Landroid/webkit/HTML5VideoViewProxy$VideoPlayer;->mProgressView:Landroid/view/View;
