...
.method protected onPushMsg(ILjava/lang/String;BBBLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1328
    .local v20, bMessage:Lcom/broadcom/bt/util/bmsg/BMessage;
    const-string v5, "MapSMSProvider"
    ...
    :cond_1
    :try_start_0
    invoke-virtual/range {v20 .. v20}, Lcom/broadcom/bt/util/bmsg/BMessage;->getMessageType()B
    ...
    :cond_6
    :try_start_2
    invoke-virtual/range {v20 .. v20}, Lcom/broadcom/bt/util/bmsg/BMessage;->isRead()Z

    move-result v11

    .line 1369
    invoke-virtual/range {v20 .. v20}, Lcom/broadcom/bt/util/bmsg/BMessage;->getEnvelope()Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;
    ...
    .line 1377
    .local v24, bRecipient:Lcom/broadcom/bt/util/bmsg/BMessageVCard;
    if-nez v24, :cond_8
    ...
    .line 1385
    .local v21, bProp:Lcom/broadcom/bt/util/bmsg/BMessageVCardProperty;
    if-nez v21, :cond_c

    .line 1386
    invoke-virtual/range {v17 .. v17}, Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;->getChildEnvelope()Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;

    move-result-object v18

    .line 1388
    .local v18, bEnv1:Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;
    invoke-virtual/range {v18 .. v18}, Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;->getRecipient()Lcom/broadcom/bt/util/bmsg/BMessageVCard;

    move-result-object v25

    .line 1389
    .local v25, bRecipient1:Lcom/broadcom/bt/util/bmsg/BMessageVCard;
    if-nez v25, :cond_9

    .line 1390
    const-string v5, "MapSMSProvider"

    const-string/jumbo v6, "onPushMsg(): Unable to process BMessage. Recipient1 is null"
    ...
    .line 1396
    .local v22, bProp1:Lcom/broadcom/bt/util/bmsg/BMessageVCardProperty;
    if-nez v22, :cond_d

    .line 1397
    invoke-virtual/range {v18 .. v18}, Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;->getChildEnvelope()Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;

    move-result-object v19

    .line 1399
    .local v19, bEnv2:Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;
    invoke-virtual/range {v19 .. v19}, Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;->getRecipient()Lcom/broadcom/bt/util/bmsg/BMessageVCard;

    move-result-object v26

    .line 1400
    .local v26, bRecipient2:Lcom/broadcom/bt/util/bmsg/BMessageVCard;
    if-nez v26, :cond_a

    .line 1401
    const-string v5, "MapSMSProvider"

    const-string/jumbo v6, "onPushMsg(): Unable to process BMessage. Recipient2 is null"
    ...
    .line 1406
    .local v23, bProp2:Lcom/broadcom/bt/util/bmsg/BMessageVCardProperty;
    if-nez v23, :cond_b

    .line 1407
    const-string v5, "MapSMSProvider"

    const-string/jumbo v6, "onPushMsg(): Unable to process BMessage. Recipient2 TEL property is null"
    ...
    .line 1423
    .end local v18           #bEnv1:Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;
    .end local v19           #bEnv2:Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;
    .end local v22           #bProp1:Lcom/broadcom/bt/util/bmsg/BMessageVCardProperty;
    .end local v23           #bProp2:Lcom/broadcom/bt/util/bmsg/BMessageVCardProperty;
    .end local v25           #bRecipient1:Lcom/broadcom/bt/util/bmsg/BMessageVCard;
    .end local v26           #bRecipient2:Lcom/broadcom/bt/util/bmsg/BMessageVCard;
    :cond_c
    :goto_2
    invoke-virtual/range {v21 .. v21}, Lcom/broadcom/bt/util/bmsg/BMessageVCardProperty;->getValue()Ljava/lang/String;
    ...
    .restart local v18       #bEnv1:Lcom/broadcom/bt/util/bmsg/BMessageEnvelope;
    .restart local v22       #bProp1:Lcom/broadcom/bt/util/bmsg/BMessageVCardProperty;
    .restart local v25       #bRecipient1:Lcom/broadcom/bt/util/bmsg/BMessageVCard;
    :cond_d
    move-object/from16 v17, v18
    ...
    .end local v22           #bProp1:Lcom/broadcom/bt/util/bmsg/BMessageVCardProperty;
    .end local v25           #bRecipient1:Lcom/broadcom/bt/util/bmsg/BMessageVCard;
    .restart local v15       #bBody:Lcom/broadcom/bt/util/bmsg/BMessageBody;
    :cond_e
    ...
    .line 1440
    .local v30, next:Ljava/lang/String;
    :goto_3
    ...
    .end local v21           #bProp:Lcom/broadcom/bt/util/bmsg/BMessageVCardProperty;
    .end local v24           #bRecipient:Lcom/broadcom/bt/util/bmsg/BMessageVCard;
    .end local v29           #msgType:B
    .end local v30           #next:Ljava/lang/String;
    :cond_10
    if-nez p5, :cond_11
    ...
    .line 1461
    .local v31, sUTF8Content:Ljava/lang/String;
    if-nez v31, :cond_14

    .line 1476
    .end local v31           #sUTF8Content:Ljava/lang/String;
    :cond_11
    invoke-virtual/range {v20 .. v20}, Lcom/broadcom/bt/util/bmsg/BMessage;->finish()V
    ...
    .line 1481
    .local v28, messageUri:Landroid/net/Uri;
    :try_start_3
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v28 .. v28}, Landroid/net/Uri;->getLastPathSegment()Ljava/lang/String;
    ...
    .line 1466
    .end local v28           #messageUri:Landroid/net/Uri;
    .restart local v9       #subject:Ljava/lang/String;
    .restart local v31       #sUTF8Content:Ljava/lang/String;
    :cond_14
    const-string v5, "MapSMSProvider"
    ...
    .restart local v28       #messageUri:Landroid/net/Uri;
    :cond_15
    :try_start_4
