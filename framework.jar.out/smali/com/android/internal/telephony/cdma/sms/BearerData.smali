...
.method private static decodeCMASPayload(Lcom/android/internal/telephony/cdma/sms/BearerData;)Z
    ...
    invoke-direct {v3, v6}, Lcom/android/internal/util/BitwiseInputStream;-><init>([B)V

    .line 1202
    .local v3, inStream:Lcom/android/internal/util/BitwiseInputStream;
    const-string v6, "SMS"

    const-string v7, "decodeCMASPayload()"
    ...
    const-string v8, "decodeCMASPayload():available1 = "
    ...
    .restart local v3       #inStream:Lcom/android/internal/util/BitwiseInputStream;
    :cond_0
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/sms/BearerData;->cmasData:Lcom/android/internal/telephony/cdma/sms/CMASdata;

    if-nez v6, :cond_1

    .line 1213
    new-instance v6, Lcom/android/internal/telephony/cdma/sms/CMASdata;

    invoke-direct {v6}, Lcom/android/internal/telephony/cdma/sms/CMASdata;-><init>()V

    iput-object v6, p0, Lcom/android/internal/telephony/cdma/sms/BearerData;->cmasData:Lcom/android/internal/telephony/cdma/sms/CMASdata;

    .line 1214
    :cond_1
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/sms/BearerData;->cmasData:Lcom/android/internal/telephony/cdma/sms/CMASdata;

    iput v2, v6, Lcom/android/internal/telephony/cdma/sms/CMASdata;->version:I
    ...
    const-string v8, "decodeCMASPayload():available2 = "
    ...
    const-string v8, "decodeCMASPayload():record type = "
    ...
    const-string v8, "decodeCMASPayload():Unsupported Record found,skipping, available = "
    ...
    const-string v7, "decodeCMASPayload BearerData decode failed: "
    ...
    const-string v8, "decodeCMASPayload():Msg Record found, available = "
    ...
    const-string v8, "decodeCMASPayload():Category Record found, available = "
    ...
    const-string v8, "decodeCMASPayload():Identifier Record found, available = "
...
.method private static encodeEmsUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;)V
    ...
    .prologue
    const-string v6, "encode ems - unicode16"

    const-string v5, "encode ems - 7bit gsm"
    ...
    const-string v2, "encode ems - 7bit gsm"
    ...
    const-string v2, "encode ems - unicode16"
    ...
    const-string v3, "encode ems - 7bit gsm"
...
.method private static encodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;)V
    ...
    const-string v2, "encode ems user data"
    ...
    const-string v2, "encode 7 bit gsm"
    ...
    const-string v2, "encode 7 bit ascii"
    ...
    const-string v2, "encode unicode16"
    ...
    const-string v3, "encode 7 bit ascii"
