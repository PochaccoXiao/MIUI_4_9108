...
.method public fakedisconnect(Landroid/os/Message;)V
    .locals 3
    .parameter "onCompletedMsg"
    ...
    const-string v1, "fakedisconnect executed"
...
.method protected onConnect(Lcom/android/internal/telephony/DataConnection$ConnectionParams;)V
    ...
    .line 97
    .local v11, simNum:Ljava/lang/String;
    const/4 v9, 0x0
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/gsm/ApnSetting;->apn:Ljava/lang/String;

    const-string v1, "labwap3"
    ...
    const-string v1, "APN is labwap3, so isCMRI is true"
